//
//  chooseTheRestaurantBelowViewController.swift
//  OrderConveniently
//
...
class chooseTheRestaurantBelowViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
...
//            if let nextController = segue.destination as? ItemDetailsViewController{
//                nextController.resNameFromLastController = sender as? String
//            }
//        }
//    }
...
//child("data").child(user.uid).child("resName").
                ...
                databaseHandle = ref.child("main_data").child("dorm_apts").observe(.childAdded, with: { (snapshot) in
